...
* Create a public comprehensive database listing of all data holdings.
* Maintain and update the data inventory in a timely manner.
* . . .
...
## City of Austin Data Inventory Policy Requirements
